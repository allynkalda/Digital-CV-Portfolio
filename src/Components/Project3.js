        ...
        <div className="project-boxes"><section>
            <Tile kind="ancestor">
                ...
                <Tile kind="parent" horizontal>
                    ...
                    <Tile renderAs="p" kind="child"  className="box" >
                        ...
                        <img className="project-image" src="./images/dont-kill-kenny-game.png"  alt="game screenshot"/>
                ...
                <Tile kind="parent" horizontal>
                    <Tile renderAs="p" kind="child" className="box" >
                        ...
                        <img className="project-image" src="./images/kanye-generator.png" alt="quote generator screenshot"/>
                        <div className="space-top">
